...
static ssize_t read_first(struct file*, char*, size_t, loff_t*);
static ssize_t read_second(struct file*, char*, size_t, loff_t*);
static ssize_t read_operation(struct file*, char*, size_t, loff_t*);
static ssize_t read_result(struct file*, char*, size_t, loff_t*);

static ssize_t write_first(struct file*, const char*, size_t, loff_t*);
static ssize_t write_second(struct file*, const char*, size_t, loff_t*);
static ssize_t write_operation(struct file*, const char*, size_t, loff_t*);
...
static const char calculator_first_name[] = "first";
static const char calculator_second_name[] = "second";
static const char calculator_operation_name[] = "operation";
static const char calculator_result_name[] = "result";
...
static ssize_t read_first(struct file* filp, char* buff, size_t count, loff_t* offset)
{
...
static ssize_t read_second(struct file* filp, char* buff, size_t count, loff_t* offset)
{
    if (*offset >= NUMBER_SIZE) {
        return 0;
    }
...
static ssize_t read_operation(struct file* filp, char* buff, size_t count, loff_t* offset)
{
...
static ssize_t read_result(struct file* filp, char* buff, size_t count, loff_t* offset)
{
...
static ssize_t write_first(struct file* filp, const char* buff, size_t count, loff_t* offset)
{
    if (count > NUMBER_SIZE) {
...
static ssize_t write_second(struct file* filp, const char* buff, size_t count, loff_t* offset)
{
    if (count > NUMBER_SIZE) {
        printk("error: too big data\n");
        return -EINVAL;
...
static ssize_t write_operation(struct file* filp, const char* buff, size_t count, loff_t* offset)
{
    if (count > OPERATION_SIZE) {
        printk("error: too big data\n");
        return -EINVAL;
